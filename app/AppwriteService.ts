...
export const SsrHostname: string = 'remix.ssr.almostapps.eu';
export const AppwriteHostname: string = 'appwrite.remix.ssr.almostapps.eu';

export const AppwriteEndpoint = 'https://appwrite.remix.ssr.almostapps.eu/v1';
